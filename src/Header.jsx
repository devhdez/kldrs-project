    ...
    return (
      ...
      {/* md:items-center md:justify-between  */}
        ...
        <div className="flex py-2 md:ml-4 md:mt-0">
          ...
          <button
            type="button"
            className="mr-5 ml-3 inline-flex place-self-center rounded-md bg-amber-100 px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-amber-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            Contact
          </button>
